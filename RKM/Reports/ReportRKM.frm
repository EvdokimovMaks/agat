...
.begin
  if v.getfirst mnplan = tsok
  {
    case v.mnplan.cwayaccou of
      ...
      0001000000000172h: runinterface(AGAT::ReportRKMForm8D, comp(_MNREC), 'РКМ Форма 8Д 7 РАСШИФРОВКА ЗП И ТРУДОЗАТРАТ', 0);    //'РКМ_Форма 8Д_РАСШИФРОВКА_ЗП_И_ТРУДОЗАТРАТ'
