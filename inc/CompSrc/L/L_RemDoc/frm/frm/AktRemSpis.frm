...
.fields
  ...
  Организация_ОКОНХ
  Организация_ТЕЛ
  Организация_КонтИнф             // KatOrg.CONTAKTS      Контактная информация
  Организация_Email               // KatOrg.EMAIL         Электронный почтовый адрес
  Организация_OKATO               // PodrInfo.OKATO       Код по общероссийскому классификатору административно-территориального деления
  Организация_KBK                 // PodrInfo.KBK         Код бюджетной классификации
  Организация_OGRN                // PodrInfo.OGRN        Основной государственный регистрационный номер
  Организация_РегНом_в_ПФ         // PodrInfo.REGNOMPFR   Регистрационный номер в ПФ
  Организация_РегНом_Страхователя // PodrInfo.POlE3S      Регистрационный номер страхователя
  Организация_Орган_Исполн_Власти // PodrInfo.INSNAME     Орган исполнительной власти
  Организация_Форма_Собственности // FormSobs.Name        Форма собственности
  Организация_Вид_Деятельности    // FormSobs.VidD        Вид деятельности 
  ...
  ОрганизацияУНН
  ОрганизацияКПП                  // KatOrg.KODPLATNDS       =  28 ПОЛЕЙ
 ...
 Довер_Дата :date
   ...
   Контрагент_ОКОНХ
   Контрагент_ТЕЛ
  Контрагент_КонтИнф             // KatOrg.CONTAKTS      Контактная информация
  Контрагент_Email               // KatOrg.EMAIL         Электронный почтовый адрес
  Контрагент_OKATO               // PodrInfo.OKATO       Код по общероссийскому классификатору административно-территориального деления
  Контрагент_KBK                 // PodrInfo.KBK         Код бюджетной классификации
  Контрагент_OGRN                // PodrInfo.OGRN        Основной государственный регистрационный номер
  Контрагент_РегНом_в_ПФ         // PodrInfo.REGNOMPFR   Регистрационный номер в ПФ
  Контрагент_РегНом_Страхователя // PodrInfo.POlE3S      Регистрационный номер страхователя
  Контрагент_Орган_Исполн_Власти // PodrInfo.INSNAME     Орган исполнительной власти
  Контрагент_Форма_Собственности // FormSobs.Name        Форма собственности
  Контрагент_Вид_Деятельности    // FormSobs.VidD        Вид деятельности 
   ...
   КонтрагентУНН
   КонтрагентКПП                  // KatOrg.KODPLATNDS       =  28 ПОЛЕЙ
       Контрагент_БАНК_Имя
...
.{
  ...
  Организация_KBK                             ^
  Организация_OGRN                            ^
  Организация_РегНом_в_ПФ                     ^
  Организация_РегНом_Страхователя             ^
  Организация_Орган_Исполн_Власти             ^
  Организация_Форма_Собственности             ^
  Организация_Вид_Деятельности                ^
  Организация_СТАРАНА_КОД                     ^
  Организация_СТРАНА_ИМЯ                      ^
  Организация_СТРАНА_НАЛОГИ                   ^
  Организация_ГОРОД_КОД                       ^
 ...
 Довер_ФИО ^ Довер_Номер ^ Довер_Дата ^
   ...
   Контрагент_KBK                             ^
   Контрагент_OGRN                            ^
   Контрагент_РегНом_в_ПФ                     ^
   Контрагент_РегНом_Страхователя             ^
   Контрагент_Орган_Исполн_Власти             ^
   Контрагент_Форма_Собственности             ^
   Контрагент_Вид_Деятельности                ^
   Контрагент_СТАРАНА_КОД                     ^
   Контрагент_СТРАНА_ИМЯ                      ^
   Контрагент_СТРАНА_НАЛОГИ                   ^
   Контрагент_ГОРОД_КОД                       ^
...
.fields
 ...
 КодМЦ Название ОтпЕд 
 DoubleToStr(КолДО, '[|-]3666`666`666`666`666.' + PadCh('','8',wGetTune('ROUND.KOLSIGN'))) 
 DoubleToStr(КолФ , '[|-]3666`666`666`666`666.' + PadCh('','8',wGetTune('ROUND.KOLSIGN')))  
 ЦНац ЦВал СтНац СтВал
