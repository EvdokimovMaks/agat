...
.begin
 ...
 If  Trim (Не_работник)  <> '1'
 {
   if  Double(Налог5_3)  > Double(Налог5_4)
     RДолг5_8 := Double(Налог5_3) - Double(Налог5_4) - Double(Налог5_5)
   else
...
.endFields
<?xml version="1.0" encoding="windows-1251"?>
<НДФЛ2 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ВерсФорм="4.00001" ВерсПрог="4.214"
ИдФайл="^">
.fields
 год_за_который_отчет
 номер
