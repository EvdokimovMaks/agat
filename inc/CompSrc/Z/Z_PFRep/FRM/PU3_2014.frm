...
if(CharF<>2, if(God>2012, DoubleToStr(Pach_UdItog+Pach_28VzItog+Pach_6VzItog,'[|-]3666666666666'), string(0)),string(0))          // ë„¨¨† „§•‡¶†≠®Ô (1%) + Ø•≠·®Æ≠≠ÎÂ ¢ß≠Æ·Æ¢ (28%) + ·‚‡†ÂÆ¢ÎÂ ¢ß≠Æ·Æ¢ (6%) ØÆ Ø†Á™•
if(CharF<>2, if(God>2012, DoubleToStr(Pach_UdUplItog+Pach_28VzUplItog+Pach_6VzUplItog,'[|-]3666666666666'), string(0)),string(0)) // ë„¨¨† „Ø´†Á•≠≠Æ£Æ „§•‡¶†≠®Ô (1%) + „Ø´†Á•≠≠ÎÂ ¢ß≠Æ·Æ¢ 34%(28+6) ØÆ Ø†Á™•
.endfields
áÉãÇ=1.6=
<èÄóä=^=^=^=^= = =1=
íàèÑ=èì-3=^=^=^=^=^=>
...
if((CharF <> 2)and(ISum1      <> 0),DoubleToStr(ISum1,   '[|-]3666666666666'), string(0))
if((CharF <> 2)and(ISum2      <> 0),DoubleToStr(ISum2,   '[|-]3666666666666'), string(0))
if((CharF <> 2)and(ISumUd1    <> 0),DoubleToStr(ISumUd1, '[|-]3666666666666'), string(0))
if((CharF <> 2)and(ISum28Vz   <> 0),DoubleToStr(ISum28Vz,'[|-]3666666666666'), string(0))
if((CharF <> 2)and(ISum6Vz    <> 0),DoubleToStr(ISum6Vz, '[|-]3666666666666'), string(0))
if((CharF <> 2)and(ISumUdUpl1 <> 0),if(God>2012,DoubleToStr(ISumUdUpl1,'[|-]3666666666666'), ' '), if(God>2012, string(0), ' '))
if((CharF <> 2)and(ISumVzUpl  <> 0),if(God>2012,DoubleToStr(ISumVzUpl, '[|-]3666666666666'), ' '), if(God>2012, string(0), ' '))
