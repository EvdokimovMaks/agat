...
.[h
┌─────┬───────────────┬──────────────────────────┬──────────┬──────────────┬──────────────────┬─────────┬──────────────────┬────────────────────────────┬──────────────────┐
│     │               │                          │Шифр групп│     Дата     │  Первоначальная  │ Коэффи- │   Восстанови-    │   Накопленная амортизация  │    Остаточная    │
│  №  │  Инвентарный  │       Наименование       │ основных │   принятия   │    стоимость     │  циент  │     тельная      ├───────────┬────────────────┤    стоимость     │
...
.[h
┌─────┬───────────────┬──────────────────────────┬──────────┬──────────────┬──────────────────┬─────────┬───────────┬──────────────────┬────────────────────────────┬──────────────────┐
│     │               │                          │Шифр групп│     Дата     │  Первоначальная  │ Коэффи- │ Корректи- │   Восстанови-    │   Накопленная амортизация  │    Остаточная    │
│  №  │  Инвентарный  │       Наименование       │ основных │   принятия   │    стоимость     │  циент  │  рующий   │     тельная      ├───────────┬────────────────┤    стоимость     │
