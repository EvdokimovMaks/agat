...
#doc
Реестр хозяйственных операций для бухпроводок (скрытая базовая форма)
#end
.set name = 'REEHOZOB'
.hide
.fields
...
TiDk_NameTxo Наименование ТХО (Название документа и операции в скобках) ^
.{
...
#doc
1. Реестр хозяйственных операций для бухпроводок (по контрагентам)
#end
.linkform 'reehozob_01' prototype is 'reehozob'
...
SimvBV
TiDk_NameTxo
Date_SH Nom_SH Org_SH DO_SH SumNDE_SH SumBV_SH SumVal_SH SimvVal_SH
ItogoTXO_SumNDE
ItogoTXO_SumBV
Itogo_SumNDE
Itogo_SumBV
.endfields
 Ш^
                                                   БРеестр хозяйственных операций Б
                                                  ^
...
 Б──────────┬─────────┬──────────────────────────────────┬────────────────────────────────┬─────────────────────────────────────────────────────┬──────
          │         │                                  │                                │                       Сумма в                       │ Симв.
   Дата   │ N док-та│      Организация-Контрагент      │       Документ-Основание       ├─────────────────┬─────────────────┬─────────────────┤      
          │         │                                  │                                │ @@@@@@@@@@@@@@@ │ @@@@@@@@@@@@@@@ │      валюте     │ вал.
──────────┴─────────┴──────────────────────────────────┴────────────────────────────────┴─────────────────┴─────────────────┴─────────────────┴────── Б
.{                                                                                  
 БTXO: @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Б
...
#doc
2. Реестр хозяйственных операций для бухпроводок (по операциям)
#end
.linkform 'reehozob_02' prototype is 'reehozob'
...
#doc
3. Реестр хозяйственных операций и проводок к ним для бухпроводок
#end
.linkform 'reehozob_03' prototype is 'reehozob'
...
TiDk_NameTxo
Date_SH Nom_SH Soder_SH SumNDE_SH SumBV_SH SumVal_SH SimvVal_SH
               SodPr    SumNDE    SumBV    SumVal    SimvVal     SchO SubSchO KauO SchK SubSchK KauK
ItogoTXO_SumNDE
ItogoTXO_SumBV
Itogo_SumNDE
Itogo_SumBV
...
 Б──────────┬─────────┬───────────────────────────────────────────┬─────────────────────────────────────────────────────┬────┬────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  Дата    │N док-та │     Содержание операции, проводки         ├─────────────────┬─────────────────┬─────────────────┤    ├──────┬──────┬────────────────────────────────────┬──────┬──────┬───────────────────────────────────
          │         │                                           │ @@@@@@@@@@@@@@@ │ @@@@@@@@@@@@@@@ │      валюте     │вал.│ Счет │ C/сч │                КАУ Дебета          │ Счет │ С/сч │            КАУ Кредита
──────────┴─────────┴───────────────────────────────────────────┴─────────────────┴─────────────────┴─────────────────┴────┴──────┴──────┴────────────────────────────────────┴──────┴──────┴─────────────────────────────────── Щ
 Ш.{
 БTXO: @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── Щ
...
#doc
4. Реестр хозяйственных операций для бухпроводок (по датам проводок)
#end
.linkform 'reehozob_04' prototype is 'reehozob'
