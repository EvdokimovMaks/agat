...
!{RepKrVekslTotalLoop
  ...
  КРЕД_ИТОГО_Tail_TempDescr_TableCode : word // код таблицы по которой построена данная группировка
...
!{RepKrTotalLoop
  ...
  ИТОГО_Tail_TempDescr_TableCode : word // код таблицы по которой построена данная группировка
...
!{RepKrVekslGroupLoop
  ...
  КРЕД_ГРУП_Head_TempDescr_TableCode : word // код таблицы по которой построена данная группировка
...
!{RepKrGroupLoop
  ...
  Группировка_Head_TempDescr_TableCode : word // код таблицы по которой построена данная группировка
...
!{RepKrGrafLoop
  ...
  График_СуммаВыдачи_НДЕ            : double
  График_СуммаПогашения             : double
  График_СуммаПогашения_ВО          : double
  График_СуммаПогашения_НДЕ         : double
  График_СуммаПогашенияПроцентов    : double
  График_СуммаПогашенияПроцентов_ВО : double
  График_СуммаПогашенияПроцентов_НДЕ: double
  График_СуммаПогашенияПроч         : double
  График_СуммаПогашенияПроч_ВО      : double
  График_СуммаПогашенияПроч_НДЕ     : double
  График_Валюта

  График_КРЕД_Номер
  График_КРЕД_Дата_Выписки
  График_КРЕД_Дата_Гашения     // когда должен быть погашен
  График_КРЕД_Дата_Погашен     // когда был погашен
  График_КРЕД_Проценты  : double
  График_КРЕД_Сумма_НДЕ : double
  График_КРЕД_Сумма_Вал : double
  График_КРЕД_Сумма_ВО  : double
!}
...
!{RepKrPlatLoop
  ...
  Платеж_СуммаВыдачи_НДЕ            : double
  Платеж_СуммаПогашения             : double
  Платеж_СуммаПогашения_ВО          : double
  Платеж_СуммаПогашения_НДЕ         : double
  Платеж_СуммаПогашенияПроцентов    : double
  Платеж_СуммаПогашенияПроцентов_ВО : double
  Платеж_СуммаПогашенияПроцентов_НДЕ: double
  Платеж_СуммаПогашенияПроч         : double
  Платеж_СуммаПогашенияПроч_ВО      : double
  Платеж_СуммаПогашенияПроч_НДЕ     : double
  Платеж_Валюта

  Платеж_КРЕД_Номер
  Платеж_КРЕД_Дата_Выписки
  Платеж_КРЕД_Дата_Гашения     // когда должен быть погашен
  Платеж_КРЕД_Дата_Погашен     // когда был погашен
  Платеж_КРЕД_Проценты  : double
  Платеж_КРЕД_Сумма_НДЕ : double
  Платеж_КРЕД_Сумма_Вал : double
  Платеж_КРЕД_Сумма_ВО  : double
!}
!}
.endfields
! ==============================================================================
...
───────────┬───────────┬─────────────────────────────────────────────────────────────────────────────────────────┬──────────────────────────────────────────────────────────────────────────────────────────────────────
   ...
   Номер   │ Тип этапа ├──────────┬─────────────────┬─────────────────────────────────────────────────────┬──────┼────────────┬──────────┬─────────────────┬─────────────────────────────────────────────────────┬──────
 договора  │           │   Дата   │  Сумма выдачи   │                   Сумма погашения                   │Валюта│   Номер    │   Дата   │  Сумма выдачи   │                   Сумма погашения                   │Валюта
           │           │          │                 ├─────────────────┬─────────────────┬─────────────────┤      │ платежного │          │                 ├─────────────────┬─────────────────┬─────────────────┤
...
.fields
  ...
  DoubleToStr(КРЕД_ИТОГО_График_СуммаВыдачи_НДЕ,             Формат_Сумм)
  DoubleToStr(КРЕД_ИТОГО_График_СуммаПогашения_НДЕ,          Формат_Сумм)
  DoubleToStr(КРЕД_ИТОГО_График_СуммаПогашенияПроцентов_НДЕ, Формат_Сумм)
  DoubleToStr(КРЕД_ИТОГО_График_СуммаПогашенияПроч_НДЕ,      Формат_Сумм)
  sGetTune('NDE.SimvRub')

  DoubleToStr(КРЕД_ИТОГО_Платеж_СуммаВыдачи_НДЕ,             Формат_Сумм)
  DoubleToStr(КРЕД_ИТОГО_Платеж_СуммаПогашения_НДЕ,          Формат_Сумм)
  DoubleToStr(КРЕД_ИТОГО_Платеж_СуммаПогашенияПроцентов_НДЕ, Формат_Сумм)
  DoubleToStr(КРЕД_ИТОГО_Платеж_СуммаПогашенияПроч_НДЕ,      Формат_Сумм)
  sGetTune('NDE.SimvRub')
.endfields
 Б@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Б Сумма  Б&'&&&&&&&&&&&&.&& Б Процент годовых  Б&&&.&&&&& % Б К оплате  Б&'&&&&&&&&&&&&.&& @@@@@@ Б
                                    Б&'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@                         &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@ Б
.{?Internal;if (КРЕД_ИТОГО_ВГруппировкеПоВалюте and not Ведомость_в_валюте_отчета, (VekslCurrGrpCVal <> 0), (VOсVal <> 0));
 Б                                   &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@                         &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@ Б
.}
.}
! ------------------------------------------------------------------------------
...
.fields
  ...
  DoubleToStr(ИТОГО_График_СуммаВыдачи_НДЕ,             Формат_Сумм)
  DoubleToStr(ИТОГО_График_СуммаПогашения_НДЕ,          Формат_Сумм)
  DoubleToStr(ИТОГО_График_СуммаПогашенияПроцентов_НДЕ, Формат_Сумм)
  DoubleToStr(ИТОГО_График_СуммаПогашенияПроч_НДЕ,      Формат_Сумм)
  sGetTune('NDE.SimvRub')
  DoubleToStr(ИТОГО_Платеж_СуммаВыдачи_НДЕ,             Формат_Сумм)
  DoubleToStr(ИТОГО_Платеж_СуммаПогашения_НДЕ,          Формат_Сумм)
  DoubleToStr(ИТОГО_Платеж_СуммаПогашенияПроцентов_НДЕ, Формат_Сумм)
  DoubleToStr(ИТОГО_Платеж_СуммаПогашенияПроч_НДЕ,      Формат_Сумм)
  sGetTune('NDE.SimvRub')
.endfields
 Б^ Б
                                    Б&'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@                         &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@ Б
.{?Internal;if (ИТОГО_ВГруппировкеПоВалюте and not Ведомость_в_валюте_отчета, (CurrGrpCVal <> 0), (VOсVal <> 0));
 Б                                   &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@                         &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@ Б
.}
.}
! ------------------------------------------------------------------------------
...
.fields
  ...
  DoubleToStr(График_СуммаВыдачи_НДЕ,             Формат_Сумм)
  DoubleToStr(График_СуммаПогашения_НДЕ,          Формат_Сумм)
  DoubleToStr(График_СуммаПогашенияПроцентов_НДЕ, Формат_Сумм)
  DoubleToStr(График_СуммаПогашенияПроч_НДЕ,      Формат_Сумм)
  sGetTune('NDE.SimvRub')
.endfields
@@@@@@@@@@@ @@@@@@@@@@@ @@@@@@@@@@ &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@
.{?Internal;if (Ведомость_в_валюте_отчета, (VOсVal <> 0), (GrafCVal <> 0));
                                   &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@
.}
.}
! ------------------------------------------------------------------------------
...
.fields
  ...
  DoubleToStr(Платеж_СуммаВыдачи_НДЕ,             Формат_Сумм)
  DoubleToStr(Платеж_СуммаПогашения_НДЕ,          Формат_Сумм)
  DoubleToStr(Платеж_СуммаПогашенияПроцентов_НДЕ, Формат_Сумм)
  DoubleToStr(Платеж_СуммаПогашенияПроч_НДЕ,      Формат_Сумм)
  sGetTune('NDE.SimvRub')
.endfields
@@@@@@@@@@@ @@@@@@@@@@@                                                                                           @@@@@@@@@@@@ @@@@@@@@@@ &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@
.{?Internal; if (Ведомость_в_валюте_отчета, (VOсVal <> 0), (BaseFinCVal <> 0));
                                                                                                                                          &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& &'&&&&&&&&&&&&.&& @@@@@@
.}
.}
.}
...
// -- sZalog -----------------------------------------------------------------
  if (Zalog.cAval = comp(0), Zalog.NameOrg, 'Договор № ' + Dogovor.NoDoc + ' от ' + string(Dogovor.dDoc))
From
  Aval    (ReadOnly),
  KatOrg  (ReadOnly),
  Dogovor (ReadOnly),
...
.fields
  Платеж_КРЕД_Номер
  Платеж_КРЕД_Дата_Выписки
  Платеж_КРЕД_Дата_Гашения
  Платеж_КРЕД_Проценты
  DoubleToStr(if (Ведомость_в_валюте_отчета, Платеж_КРЕД_Сумма_ВО, if (BaseFinCVal = 0, Платеж_КРЕД_Сумма_НДЕ, Платеж_КРЕД_Сумма_Вал)), Формат_Сумм)
  if (Ведомость_в_валюте_отчета, Валюта_Отчета, Платеж_Валюта)
