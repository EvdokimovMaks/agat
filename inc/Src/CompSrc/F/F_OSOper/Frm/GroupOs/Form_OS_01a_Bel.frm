...
.{
! ***** Заполнение массивов *****
#FeeSigners_Os_LinkInit(GroupOs)
...
.begin
  ...
  Массив_ИК_Фактический_срок_эксплуатации     [НомерИК] := iExcelFormat.SrokIspEdIzmWord (Фактический_срок_эксплуатации);       // 09 - Фактический срок эксплуатации (лет,месяцев)
  ...
  Массив_ИК_Срок_полезного_использования      [НомерИК] := iExcelFormat.SrokIspEdIzmWord (Срок_полезного_использования);        // 15 - Срок полезного использования
...
.fields
  ...
  iExcelFormat.DateToStrRep(Дата_приказа)                                   // Дата_приказа
  iExcelFormat.DateToStrRep(Итог_Дата_принятия_к_бухгалтерскому_учету)      // Дата принятия к бухгалтерскому учету
  iExcelFormat.DateToStrRep(Дата_выбытия)                                   // Дата списания с бухгалтерского учета

  if ((isBudjetOrg=true) and (ТипОперации=4),Кред_Счет_СубСчет,Счет_СубСчет)                 // Счет, субсчет, код аналитического учета
  ...
  Итог_Государственная_регистрация_прав_на_недвижимость_Номер
  iExcelFormat.DateToStrRep(Итог_Государственная_регистрация_прав_на_недвижимость_Дата)
...
.fields
  ...
  // 06 - Дата, выпуска (год)
  iExcelFormat.DateToStrRep(Массив_ИК_Дата_выпуска [НомерИК], 'YYYY')

  // 07 - Дата, ввода в эксплуатацию
  iExcelFormat.DateToStrRep(Массив_ИК_Дата_ввода_в_эксплуатацию [НомерИК])
.endfields
   │&&&&&&&│@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@│@@@@@@@@@@@@@@@│@@@@@@@@@@@@@@@│@@@@@@@@@@@@@@@│@~@@@@@│@~@@@@@@@@│          │
...

   ...
   │    эксплуатации   │  амортизации,  │   стоимость,   │            руб.коп.             │ дату принятия к│      исполь-      │      начисления      │
   │   (лет,месяцев)   │    руб.коп.    │    руб.коп.    ├────────────────┬────────────────┤ бухгалтерскому │      зования      │      амортизации     │
   │                   │                │                │   за единицу   │      всего     │ учету, руб.коп.│                   │                      │
   ├───────────────────┼────────────────┼────────────────┼────────────────┼────────────────┼────────────────┼───────────────────┼──────────────────────┤
...
.fields
  ...
  iExcelFormat.DoubleToStrRep (Массив_ИК_Сумма_начисленной_амортизации [НомерИК] * if (DuplicateRecordInGroupIK, 1, Массив_ИК_Количество [НомерИК]))

  // 11 - Остаточная стоимость, руб.
  iExcelFormat.DoubleToStrRep (Массив_ИК_Остаточная_стоимость [НомерИК] * if (DuplicateRecordInGroupIK, 1, Массив_ИК_Количество [НомерИК]))

  // 12 - Стоимость приобретения (договорная стоимость), за единицу
  iExcelFormat.DoubleToStrRep (Массив_ИК_Стоимость_приобретения_за_единицу [НомерИК])

  // 13 - Стоимость приобретения (договорная стоимость), всего
  iExcelFormat.DoubleToStrRep ( if (DuplicateRecordInGroupIK, Массив_ИК_Стоимость_приобретения_за_единицу [НомерИК], Массив_ИК_Стоимость_приобретения_всего  [НомерИК]))

  // 14 - Первоначальная стоимость на дату принятия к бухгалтерскому учету, руб.
  if(ТипОперации = 4, '',
    iExcelFormat.DoubleToStrRep (Массив_ИК_Стоимость_принятия_к_бух_учету [НомерИК]  * if (DuplicateRecordInGroupIK, 1, Массив_ИК_Количество [НомерИК]))
    )
...
.fields
  // Итог по колонке 13
  iExcelFormat.DoubleToStrRep (Итог_Стоимость_приобретения_всего)

  // Итог по колонке 14
  if(ТипОперации = 4, '', iExcelFormat.DoubleToStrRep (Итог_Первоначальная_стоимость_всего) )
.endfields
   └───────────────────┴────────────────┴────────────────┴────────────────┼────────────────┼────────────────┼───────────────────┴──────────────────────┘
                                                                    Итого │&&&&&&&&&&&&&.&&│&&&&&&&&&&&&&.&&│
                                                                          └────────────────┴────────────────┘
