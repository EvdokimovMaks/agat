...
.group 'Поступление ОС для НМА <<ВСМН>>'
.group 'Внутреннее перемещение ОС для НМА <<Россия>>'
.group 'Внутреннее перемещение ОС для НМА <<ВСМН>>'
.group 'Выбытие ОС для НМА <<Россия>>'
.group 'Выбытие ОС для НМА <<ВСМН>>'
.f "OS-1b.out"
.hide
.defo portrait
.p 86
...
.begin
  ...
  Массив_ИК_Фактический_срок_эксплуатации     [НомерИК] := if (Сумма_начисленной_амортизации=0, '', iExcelFormat.SrokIspEdIzmWord (Фактический_срок_эксплуатации) );   // 09 - Фактический срок эксплуатации (лет,месяцев)
  ...
  Массив_ИК_Срок_полезного_использования      [НомерИК] := iExcelFormat.SrokIspEdIzmWord (Срок_полезного_использования);        // 16 - Срок полезного использования
