...
 Ш@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
   Е@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Е                        ├────────────┤
   ...
   ┌─────┬─────────────────────────────────────────────────────────────────────────────────────┬────────────────┬────────────────────────────────────────┐
   │     │                          Объект основных средств                                    │                │         Стоимость, руб.коп.            │
   │  №  ├──────────────────────────────────────────────────────┬───────────────┬──────────────┤  Количество,   ├─────────────────────┬──────────────────┤
   │ п/п │                                                      │      Дата     │              │      шт.       │                     │                  │
...
.fields
  ...
  iExcelFormat.KolOsToStrRep( if (DuplicateRecordInGroupIK, 1, Характеристика_Количество_Объектов[НомерИК]) ) //5
...
.fields
  ...
  if (i = 1, iExcelFormat.KolOsToStrRep( if (DuplicateRecordInGroupIK, 1, Характеристика_Количество_Объектов[НомерИК]) ), '')
