...
#FeeSigners_Os_Fields
  ...
  Изменение_стоимости                    : double   // Изменение_стоимости Для ОС - 3
  Затраты_на_ремонт                      : double   // Затраты_на_ремонт Для ОС - 3
  Стоимость_после_реконструкции          : double   // Стоимость_после_реконструкции Для ОС - 3
...
.{ CheckEnter CycleByGroupIK
     { -------------------
       ...
       Изменение_стоимости                  - ^  // Изменение_стоимости Для ОС - 3
       Затраты_на_ремонт                    - ^  // Затраты_на_ремонт Для ОС - 3
       Стоимость_после_реконструкции        - ^  // Стоимость_после_реконструкции Для ОС - 3
...
.}
       ...
       { *** Начало ***** цикл по услугам *****
.{ CheckEnter FormGroupOs_AktUsl
         { -------------------
           Сумма_Услуги                      - ^  // Сумма услуги Для ОС - 3
         } -------------------
.}
       } *** Конец  ***** цикл по услугам *****
     } -------------------
.}
