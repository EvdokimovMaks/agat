...
.linkform 'GroupOs_04b' prototype is 'GroupOs'
.NameInList 'Форма N ОС-4б'
...
.begin
  ...
  Массив_ИК_Фактический_срок_эксплуатации     [НомерИК] := iExcelFormat.SrokIspEdIzmWord (Фактический_срок_эксплуатации);       // 04 - Фактический срок эксплуатации
...
 Ш@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@                                                                                                                             Унифицированная форма № ОС-4б
   ...
   ┌─────┬────────────────────────────┬───────────────┬───────────────┬────────────────┬────────────────┬────────────────┬────────────────┬───────────────────────────────────────────────────────────────────────────────────┐
   │Номер│    Наименование объекта    │  Инвентарный  │  Фактический  │ Первоначальная │      Сумма     │   Остаточная   │    Причина     │            Содержание драгоценных материалов (металлов, камней и т.д.)            │
   ...
   │рядку│                            │               │               │ стоимость,руб. │  (износа),руб. │                │                │                        │     номер    │ измерения │            │                  │
   │     │                            │               │               │                │                │                │                │                        │              │  по ОКЕИ  │            │                  │
   ├─────┼────────────────────────────┼───────────────┼───────────────┼────────────────┼────────────────┼────────────────┼────────────────┼────────────────────────┼──────────────┼───────────┼────────────┼──────────────────┤
...
.fields
  ...
  iExcelFormat.DoubleToStrRep (Массив_ИК_Восстановительная_стоимость [НомерИК] * if (DuplicateRecordInGroupIK, 1, Массив_ИК_Количество [НомерИК]))
  ...
  if (Массив_ИК_КоличествоДрагМеталлов [НомерИК] <> 0, iExcelFormat.DragMToStr (Массив_ДрагМеталл_Масса [НомерДрагМеталла + i]),'') // 13
.endfields
   │&&&&&│@@@@@@@@@@@@@@@@@@@@@@@@@@@@│@@@@@@@@@@@@@@@│@@@@@@@@@@@@@@@│&&&&&&&&&&&&&.&&│&&&&&&&&&&&&&.&&│&&&&&&&&&&&&&.&&│@@@@@@@@@@@@@@@@│@@@@@@@@@@@@@@@@@@@@@@@@│              │@@@@@@@@@@@│            │&&&&&&&&&&&&&&&&&&│
...
.fields
  ...
  iExcelFormat.DragMToStr (Массив_ДрагМеталл_Масса [НомерДрагМеталла + i])                                          // 13
.endfields
   │     │                            │               │               │                │                │                │                │@@@@@@@@@@@@@@@@@@@@@@@@│              │@@@@@@@@@@@│            │&&&&&&&&&&&&&&&&&&│
.}
.begin
...

   ...
   В результате осмотра перечисленных в настоящем акте объектов основных средств с приспособлениями и принадлежностями установлено: ___________________________________________________________________________________________
