...
!Данные по ЛК, ЛС, Сотр
 ...
 Spec_FIO      : string      //ФИО работника
!Данные по нормам
!    по норме
 Spec_NormSfoNRec : comp     //NormSFo.NRec
 Spec_NormSfoCode : string   //код общей нормы СФО
 Spec_NormSfoName : string   //название общей нормы СФО
 Spec_NormSfoNacop : string  //"+" - накопительная норма, "-" - не накопительная
 Spec_NormSfoInd   : string  //"+" - единовременная норма, "-" - периодическая
!    по персональной спецификации нормы
...
.}
 Ш──────────┬─────────────────────────┬─────────────────────────┬──────────┬──────────┬─────────┬────────┬─────────┬────────┬──────────┬───┬───┬───┬────
  № ЛК    │          Норма          │       Группа СФО        │    с..   │    по..  │  Срок   │По норме│ Ед.изм. │Потребн.│ Выдача с │Нак│Ед.│Ф/С│Осн
──────────┼─────────────────────────┼─────────────────────────┼──────────┼──────────┼─────────┼────────┼─────────┼────────┼──────────┼───┼───┼───┼────
