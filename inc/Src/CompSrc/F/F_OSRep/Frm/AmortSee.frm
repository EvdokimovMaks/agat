...
.fields
  ...
  DoubleToStr(double(Node_PRPog  ), Формат_Сумм)
  ...
  DoubleToStr(double(Leaf_PRPog  ), Формат_Сумм)
...
───────────────────────────────────────────┬───────────┬───────┬───────────────────┬───────────────────┬──────────────────┬─────────────────────────────────────┬─────────────────────────────────────┬─────────────────────────────────────┬──────
              Наименование                 │Инвентарный│Период │@~@@@@@@@@@@@@@@@@@│@~@@@@@@@@@@@@@@@@@│     Разность     │              Постоянная             │        Вычитаемая временная         │     Налогооблагаемая временная      │Валюта
                                           ...
                                           │           │       │       Износ       │       Износ       │                  ├──────────────────┬──────────────────┼──────────────────┬──────────────────┼──────────────────┬──────────────────┤
                                           │           │       │                   │                   │                  │    Начисление    │    Погашение     │    Начисление    │    Погашение     │    Начисление    │    Погашение     │
───────────────────────────────────────────┴───────────┴───────┴───────────────────┴───────────────────┴──────────────────┴──────────────────┴──────────────────┴──────────────────┴──────────────────┴──────────────────┴──────────────────┴──────
.]H
.{ AmortSee_Header CheckEnter
.begin
...
────────┬──────┬─────────────────────────┬─────────────────────────────┬────────────────────────────┬──────────────────┬───────────────────────────┬─────────────────────────┬───────────────────────────────────────────────────┬─────────────────────────
  ...
  ввода │  №   │                         │              │              │              │             │         │        │             │             │ вычитаемые │ налогообла │ вычитаемые │ налогообла │ постоянные │ постоянные │ вычитаемые │ налогообла
        │      │                         │       БУ     │       НУ     │      ВВР     │     НВР     │    БУ   │   НУ   │      БУ     │      НУ     │  временные │ гаемые вре │  временные │ гаемые вре │  разницы   │  разницы   │  временные │ гаемые вре
        │      │                         │              │              │              │             │         │        │             │             │  разницы   │ менные раз │  разницы   │ менные раз │ начисленные│ погашенные │  разницы   │ менные раз
...
.fields
  ...
  DoubleToStr(Leaf_PRPog_Period , Формат_Сумм)
...
────────┬─────────────┬─────────────────────────┬───────────────────────┬────────────────────┬─────────────────┬─────────────────┬────────────────┬─────────────────────────────────
  ...
  Дата  │ Инвентарный │      Наименование       │    Первоначальная     │ Постоянные разницы │  Постоянные     │    Вычитаемые   │Налогооблагаемые├────────────────┬────────────────
  ввода │    номер    │                         │    стоимость (БУ)     │  начисленные       │    разницы      │     временные   │   временные    │       БУ       │        НУ
        │             │                         │                       │                    │  погашенные     │      разницы    │    разницы     │                │
        │             │                         │                       │                    │                 │                 │                │                │
        │             │                         │                       │                    │                 │                 │                │                │
────────┼─────────────┼─────────────────────────┼───────────────────────┼────────────────────┼─────────────────┼─────────────────┼────────────────┼────────────────┼────────────────
