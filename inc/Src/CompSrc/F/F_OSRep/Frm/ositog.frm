...
!---------------- NameOS
if (Выбыл_в_текущем_периоде, '*'+KatOS_InNum, KatOS_InNum)
Тело
...
.[h
─────────────┬───────────────────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬──────────────┬───────────────
 Инвентарный │        Наименование       │    Январь    │    Февраль   │     Март     │    Апрель    │     Май      │     Июнь     │     Июль     │    Август    │   Сентябрь   │    Октябрь   │    Ноябрь    │    Декабрь   │    ИТОГО
    номер    │                           │              │              │              │              │              │              │              │              │              │              │              │              │
─────────────┴───────────────────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴──────────────┴───────────────
.]h
...
.[h
─────────────┬────────────────────────────────────┬────────────────────┬────────────────────┬────────────────────┬────────────────────┬────────────────────
 Инвентарный │             Наименование           │     I квартал      │      II квартал    │     III квартал    │     IV квартал     │       ИТОГО
    номер    │                                    │                    │                    │                    │                    │
─────────────┴────────────────────────────────────┴────────────────────┴────────────────────┴────────────────────┴────────────────────┴────────────────────
.]h
.{ CheckEnter GruppaOS3
...
.Begin
Case Вид_суммы of
 0: Вид_суммы_строка := 'балансовой стоимости';
 1: Вид_суммы_строка := 'остаточной стоимости и '
                      + if (wGetTune('Country') = ccRus, 'износа за месяц', 'амортизации за отчетный период');
 2: Вид_суммы_строка := if (wGetTune('Country') = ccRus, 'износа за месяц', 'амортизации за отчетный период');
 3: Вид_суммы_строка := if (wGetTune('Country') = ccRus, 'накопленного износа', 'накопленной амортизации');
 4: Вид_суммы_строка := 'остаточной стоимости';
 6: Вид_суммы_строка := 'накопленной переоценки стоимости';
 7: Вид_суммы_строка := 'накопленной переоценки износа';
 else
    Вид_суммы_строка := '???';
End;
End.
...
.[h
─────────────┬───────────────────────────┬──────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬─────────────┬───────────────
 Инвентарный │       Наименование        │  Сальдо на   │   Январь    │   Февраль   │    Март     │    Апрель   │    Май      │    Июнь     │    Июль     │   Август    │  Сентябрь   │   Октябрь   │   Ноябрь    │   Декабрь   │   Сальдо на
    номер    │                           │начало периода│             │             │             │             │             │             │             │             │             │             │             │             │ конец периода
─────────────┴───────────────────────────┴──────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴───────────────
.]h
.{ CheckEnter GruppaOS3
 Б@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Б &&&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&& &&&&&&&&&&&&&&&
...
.[h
─────────────┬────────────────────────────────────┬────────────────────┬────────────────────┬────────────────────┬────────────────────┬────────────────────┬────────────────────
 Инвентарный │             Наименование           │       Сальдо       │     I квартал      │      II квартал    │     III квартал    │     IV квартал     │      Сальдо
    номер    │                                    │  на начало периода │                    │                    │                    │                    │  на конец периода
─────────────┴────────────────────────────────────┴────────────────────┴────────────────────┴────────────────────┴────────────────────┴────────────────────┴────────────────────
.]h
.{ CheckEnter GruppaOS3
.Begin
...
!=============================================================================
.LinkForm 'OsItog_10' Prototype is 'ositog'
!=============================================================================
.NameInList 'Ведомости изменения с разбивкой по периоду'
.Group 'Ведомости изменения с разбивкой по периоду'
.p 60
.defo landscape
.Var
Вид_суммы_строка : String
...
.[h
─────────────┬────────────────────────────────────┬────────────────────┬────────────────────
 Инвентарный │             Наименование           │       Сальдо       │      Сальдо
    номер    │                                    │  на начало периода │  на конец периода
─────────────┴────────────────────────────────────┴────────────────────┴────────────────────
.]h
.{ CheckEnter GruppaOS3
...
!=============================================================================
.LinkForm 'OsItog_11' Prototype is 'ositog'
!=============================================================================
.NameInList 'Ведомости амортизации с разбивкой по периоду'
.Group 'Ведомости амортизации с разбивкой по периоду'
.p 80
.defo portrait
#ResponsibleLinkVar
.[h Skip
...
.[h
─────────────┬────────────────────────────────────┬────────────────────
 Инвентарный │             Наименование           │       ИТОГО
    номер    │                                    │
─────────────┴────────────────────────────────────┴────────────────────
.]h
.{ CheckEnter GruppaOS3
